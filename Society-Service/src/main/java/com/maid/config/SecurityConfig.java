...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/").permitAll().antMatchers("/society","/maid")
				.hasAnyRole("USER", "ADMIN").antMatchers("/societies","/allsocieties").hasAnyRole("ADMIN").anyRequest().authenticated()
